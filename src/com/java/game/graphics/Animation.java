...
public class Animation {
	...
	public void drawAnimation(Graphics graphics, double x, double y, int width, int heigth, int offset){
		graphics.drawImage(currentImg, (int)x - offset, (int)y, width, heigth, null);
	}
